...
forward <- readline('What is the folder and file name of the forward (R1) read fastq? (e.g. kuo_MiSeq4/K562-Guideseq-VEGF-EMX1_S1_L001_R1_001.fastq.gz)     ')
rev <- readline('What is the folder and file name of the reverse (R2) read fastq? (e.g. kuo_MiSeq4/K562-Guideseq-VEGF-EMX1_S1_L001_R2_001.fastq.gz)     ')
index1 <- readline('What is the folder and file name of the index1 (I1) read fastq? (e.g. kuo_MiSeq4/K562-Guideseq-VEGF-EMX1_S1_L001_I1_001.fastq.gz)     ')
index2 <- readline('What is the folder and file name of the index2 (I2) read fastq? (e.g. kuo_MiSeq4/K562-Guideseq-VEGF-EMX1_S1_L001_I2_001.fastq.gz)     ')
